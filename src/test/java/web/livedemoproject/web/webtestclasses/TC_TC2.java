...
public class TC_TC2 extends BaseClass { 
	...
	public TC_TC2() throws Exception {
		configFileObj = new ConfigFilesUtility();
		qf = new QFUtilities();
		configFileObj.loadPropertyFile("tc_tc2.properties");
	}
	...
	public void screensTest() throws Exception {
		for(int datasets = 1; datasets <= configFileObj.getIntProperty("datasetsLength"); datasets++) {
			...
			setup();			
			setTestcaseName(browserName,"TC_TC2 - " + configFileObj.getProperty("dataset" + (datasets)));
